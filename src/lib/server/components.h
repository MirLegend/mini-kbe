...
public:
	...
	*/
	bool checkComponents(int32 uid, COMPONENT_ID componentID, COMPONENT_TYPE componentType);
	...
	*/
	...
	void OnRegisterServer(Network::Channel* pChannel, MemoryStream& s);
	void CBRegisterServer(Network::Channel* pChannel, MemoryStream& s);

...
//-------------------------------------------------------------------------------------
INLINE const std::string& Proxy::accountName()
{
	return accountName_;
}

//-------------------------------------------------------------------------------------
INLINE void Proxy::accountName(const std::string& account)
{
	accountName_ = account;
}

//-------------------------------------------------------------------------------------
INLINE const std::string& Proxy::password()
{
	return password_;
}

//-------------------------------------------------------------------------------------
INLINE void Proxy::password(const std::string& pwd)
{
	password_ = pwd;
}
